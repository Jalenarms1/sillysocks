    ...
    <div className=''>
        ...
        <div className="flex flex-wrap min-w-screen-xl border-t border-zinc-800 mx-auto">
            ...
            <div className="w-full py-4">
                <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 xl:grid-cols-5 2xl:grid-cols-6  mt-6 px-5 max-sm:gap-5">
                    {filterBySearch(data as Product[])?.map((item: any, index: number) => (
                        <div key={index} className="bg-zinc-900 relative pb-20 shadow-md shadow-purple-300 hover:shadow-purple-600 rounded-lg overflow-hidden card   w-60 max-sm:mx-auto my-2">
